...
print(myScorecard.getName())
print(myScorecard.sort())
print(myScorecard.getScorecard())
print(myScorecard.totalScore())
print(myScorecard.getHoles())
print(myScorecard.getAdjustment())
print(myScorecard.getDeduction())
print(myScorecard.calc())